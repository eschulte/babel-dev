...
#+source: plot-Olympic-data-top-10
#+begin_src gnuplot :var data=Olympic-data :results silent
  set title '2008 Olympics Medals Awarded by Country'
  set xtic rotate by -45
  set style data histograms
  set style fill solid 1.0 border -1
  plot data using 2:xtic(1) title 'Goal Medals', \
       data using 3:xtic(1) title 'Silver Medals', \
       data using 3:xtic(1) title 'Bronze Medals'
#+end_src
