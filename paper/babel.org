...
In this paper we describe Babel, which provides a unified environment supporting many different approaches to
...
We will then describe the design and implementation of Babel (Section
...
code, and raw data constituting a scholarly work.  Compendia are
intended to facilitate the distribution, management, re-creation, and
...
requirements for use and composition of combined prose and code.
...
extraction tool (e.g. Doxygen, Javadocs, Rubydocs, etc...).
...
human reader what the program is intended to do.  Literate programming commonly
...
The Web family of tools enables TeX-based Literate Programming.  The initial
...
- block code :: Source code in a variety of languages (see Section
     ...
     - switches :: Switches controlling exportation of the code block
...
provides a number of extremely mature and full-featured environments
