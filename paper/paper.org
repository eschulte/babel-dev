...
Wherein they lay out the components of a compendium, basically a list
of the functionality required for effective RR.

**** Sweave
As an example of the /state of the art/ of RR.

List the ways in which it falls short of the compendium ideal.

*** Literate Programming
**** Knuth and Noweb
Layout the points made by knuth in his paper
