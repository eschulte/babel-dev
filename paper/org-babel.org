...
- computational communication :: will refer to the communication
     between people in which the subject is computational objects or
     results.  This communication is unique in that it must consist of
     mutually supportive sections of both prose and code.
     Computational communication can take place between people,
     groups, or even the same person at different points in time.
