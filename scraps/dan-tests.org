...
#+results:
: cd: 59: can't cd to bench/
: Tue Sep 21 21:59:00 2010
: ('Linux', 'oak', '2.6.28-15-server', '#52-Ubuntu SMP Wed Sep 9 11:34:09 UTC 2009', 'x86_64')
: /data/oak/user/davison/bench
******* shell
********* local
...
#+results:
: cd: 153: can't cd to bench/
: Tue Sep 21 22:06:20 UTC 2010
: oak
: /home/davison/bench
******* perl
********* code
...
#+results:
: cd: 105: can't cd to bench/
: Tue Sep 21 21:59:07 UTC 2010
: oak
: /data/oak/user/davison/bench
******* WORKS matlab
	:PROPERTIES:
...
#+results:
| Tue Sep 21 23:17:52 2010 | (Linux Luscinia 2.6.35-21-generic #31-Ubuntu SMP Mon Sep 13 22:39:43 UTC 2010 i686) | /home/dan |
********* remote
	  Runs remotely but no results returned
#+begin_src python :dir /davison@oak.well.ox.ac.uk:bench
  <<dir-test-python-value-nonsession>>
...
#+results:
| Tue Sep 21 22:17:58 2010 | (Linux oak 2.6.28-15-server #52-Ubuntu SMP Wed Sep 9 11:34:09 UTC 2009 x86_64) | /data/oak/user/davison/bench |
******* shell
********* local
#+begin_src sh :dir /tmp
  <<dir-test-shell-value>>
