...
#+results:
: cd: 104: can't cd to bench/
: Mon Sep 20 22:49:36 2010
: ('Linux', 'oak', '2.6.28-15-server', '#52-Ubuntu SMP Wed Sep 9 11:34:09 UTC 2009', 'x86_64')
: /data/oak/user/davison/bench
******* shell
********* local
...
#+results:
: cd: 151: can't cd to bench/
: Mon Sep 20 22:51:21 UTC 2010
: oak
: /home/davison/bench
******* perl
********* code
...
#+results:
: cd: 174: can't cd to bench/
: Mon Sep 20 22:51:35 UTC 2010
: oak
: /data/oak/user/davison/bench
******* WORKS matlab
	:PROPERTIES:
...
#+results:
| Mon Sep 20 23:57:09 2010 | (Linux Luscinia 2.6.35-21-generic #31-Ubuntu SMP Mon Sep 13 22:39:43 UTC 2010 i686) | /home/dan |
********* remote
#+begin_src python :session python-remote :dir /davison@oak.well.ox.ac.uk:bench
<<dir-test-python-value>>
#+end_src
...
#+results:
| Mon Sep 20 23:57:16 2010 | (Linux oak 2.6.28-15-server #52-Ubuntu SMP Wed Sep 9 11:34:09 UTC 2009 x86_64) | /data/oak/user/davison/bench |
******* shell
********* code
